                ...
                <div class="container">
                    ...
                    <div class="tts-blog-content">
                        <div class="clearfix mb-3">
                            <form action="<?php echo e(route('public.search.book')); ?>" method="GET">
                                ...
                                <div class="tts-blog-content-category">
                                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="tts-blog-category-item active">
                                            <a
                                                href="<?php echo e(route('frontend.get.category.book', $item->id)); ?>"><?php echo e($item->name); ?></a>
                                            <?php if(isset($id) && $item->id == $id): ?>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-4 tts-col-box-item">
                                            <div class="tts-item-book" style="height: 100%; position: relative;">
                                                <img class="img-fluid" src="/storage/<?php echo e($item->image); ?>"
                                                    onclick="javascript:location.href='<?php echo e(route('frontend.get.book', $item->id)); ?>'"
                                                    style="height: 250px; object-fit: cover; cursor: pointer" alt="">
                                                <form action="<?php echo e(route('frontend.add.to.cart')); ?>" class="form-add-to-cart"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" value="<?php echo e($item->id); ?>" name="id">
                                                    <?php if(isset(session('cart_df')[$item->id]) && session('cart_df')[$item->id] == $item->qty || $item->qty == 0): ?>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\DATN\blog\resources\views/frontend/book/list.blade.php ENDPATH**/ ?>