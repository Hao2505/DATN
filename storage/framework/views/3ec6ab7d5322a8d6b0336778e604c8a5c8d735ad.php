...
<body class="tts-pre-loading">
    ...
    <section class="tts-box-header-top d-none d-lg-block">
        <div class="container">
            <div class="tts-header-top-content">
                <p>Trụ Trì: <?php echo e($info->abbot_phone); ?> - Văn Phòng: <?php echo e($info->office_phone); ?> - Thư Ký:
                    <?php echo e($info->secretary_phone); ?></p>
            </div>
        </div>
    </section>
            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="tts-menu">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('frontend.get.list.listbook')); ?>">SÁCH</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li>
                            <a class="nav-link" href="<?php echo e(route('frontend.public.cart')); ?>"><i class="fa fa-shopping-cart"></i> <i><?php echo e($count_cart); ?></i></a>
                        </li>
                    </ul>
    ...
    <section class="tts-slider-home">
        <div class="tts-slider-main">
            <?php if(isset($sliders)): ?>
                <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tts-slider-main-item">
                        <img style="height: 70vh" src="/storage/<?php echo e($item->image); ?>" alt="">
                        <div class="tts-slider-infor">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="tts-footer-info-contact">
                        ...
                        <p>Văn Phòng - PT Trung Thống: <?php echo e($info->office_phone); ?></p>
                        <p>Thư Ký - PT Ngọc Tiên Hương: <?php echo e($info->secretary_phone); ?></p>
                    </div>
...
<?php /**PATH D:\work\DATN\blog\resources\views/frontend/layout/master.blade.php ENDPATH**/ ?>