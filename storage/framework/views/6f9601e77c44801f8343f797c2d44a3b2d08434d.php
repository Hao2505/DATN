            ...
            <section class="tts-blog-details-box">
                <div class="container">
                    <div class="tts-blog-details-box-content">
                        ...
                        <h2 class="mb-0"><?php echo e($post->name); ?></h2>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\DATN\blog\resources\views/frontend/blog/post.blade.php ENDPATH**/ ?>